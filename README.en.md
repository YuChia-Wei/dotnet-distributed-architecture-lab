...
- RabbitMQ (Kafka-parity logical request/reply listeners are configured; the Compose service is commented out and real broker connectivity/physical topology still require environment verification)
