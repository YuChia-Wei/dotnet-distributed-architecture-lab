#!/usr/bin/env python3
"""Fail-closed target-effective engineering-rule packet resolution.

This module deliberately reads only the two engineering-rule catalogs and the
target-owned effective-rule authorities.  It must not discover semantics by
walking Markdown, nor consult the source governance registry at runtime.
"""
...
class EffectiveRuleError(ValueError):
    """A target-effective resolver input is unresolved or stale."""
