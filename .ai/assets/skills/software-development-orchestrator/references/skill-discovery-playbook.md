# Software Development Orchestrator Skill Discovery Playbook

Use this playbook when the active repository may already have downstream skills, agents, prompts, or tools that can satisfy `software-development-orchestrator` capability slots.
...
`software-development-orchestrator` should treat declared `capability_slots` as stronger evidence than title or description matches.
...
- If the requested work is AI context maintenance, documentation-only governance, or repository initialization, stop software-development-orchestrator discovery and route to the owning non-development skill.
