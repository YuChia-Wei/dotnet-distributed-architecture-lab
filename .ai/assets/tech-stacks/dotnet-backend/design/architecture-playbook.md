...
[Aggregate Standards](../standards/coding-standards/aggregate-standards.md)
and [Use Case Standards](../standards/coding-standards/usecase-standards.md#7-strong-consistency-must-be-explicit).
...
- Treat same-bounded-context multi-Aggregate consistency as an exception governed
  by [Use Case Standards](../standards/coding-standards/usecase-standards.md#7-strong-consistency-must-be-explicit),
