---
name: framework-diagnostic-analyst
description: "Diagnose an observed failure or performance symptom using falsification, bounded reproduction and controlled causal isolation; report uncertainty and a repair proposal without granting repair authority."
---

# framework-diagnostic-analyst

Generated development entry for `diagnostic-analyst@0.1.0`. This entry does not prove
...
Read [the installed skill](../../../.ai/core/skills/diagnostic-analyst/SKILL.md) for its instructions. Resolve
package resources from [the installed metadata](../../../.ai/core/skills/diagnostic-analyst/skill-package.yaml), using the
...
- [references/diagnose.md](../../../.ai/core/skills/diagnostic-analyst/references/diagnose.md)
