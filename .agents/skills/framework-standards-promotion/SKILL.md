---
name: framework-standards-promotion
...
# framework-standards-promotion

Generated development entry for `standards-promotion@0.1.0`. This entry does not prove
...
Read [the installed skill](../../../.ai/core/skills/standards-promotion/SKILL.md) for its instructions. Resolve
package resources from [the installed metadata](../../../.ai/core/skills/standards-promotion/skill-package.yaml), using the
...
- [references/authority.md](../../../.ai/core/skills/standards-promotion/references/authority.md)
- [references/configuration.md](../../../.ai/core/skills/standards-promotion/references/configuration.md)
- [references/example.md](../../../.ai/core/skills/standards-promotion/references/example.md)
- [references/operations.md](../../../.ai/core/skills/standards-promotion/references/operations.md)
- [schemas/promotion-record.schema.json](../../../.ai/core/skills/standards-promotion/schemas/promotion-record.schema.json)
- [scripts/standards_promotion.py](../../../.ai/core/skills/standards-promotion/scripts/standards_promotion.py)
- [templates/promotion.md](../../../.ai/core/skills/standards-promotion/templates/promotion.md)
