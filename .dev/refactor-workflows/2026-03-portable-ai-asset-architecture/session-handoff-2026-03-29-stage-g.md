...
- Main task:
  - `.dev/refactor-workflows/2026-03-portable-ai-asset-architecture/tasks/stage-g-command-to-skill-convergence.json`
- Checklist:
  - `.dev/refactor-workflows/2026-03-portable-ai-asset-architecture/prompt-retention-checklist.md`
- Planning docs:
  - `.dev/refactor-workflows/2026-03-portable-ai-asset-architecture/stage-g-command-to-skill-convergence.md`
  - `.dev/refactor-workflows/2026-03-portable-ai-asset-architecture/command-to-skill-inventory.md`

## Recommended Resume Steps

1. Read:
   - `.dev/refactor-workflows/2026-03-portable-ai-asset-architecture/refactor-plan.md`
   - `.dev/refactor-workflows/2026-03-portable-ai-asset-architecture/stage-g-command-to-skill-convergence.md`
   - `.dev/refactor-workflows/2026-03-portable-ai-asset-architecture/tasks/stage-g-command-to-skill-convergence.json`
   - `.dev/refactor-workflows/2026-03-portable-ai-asset-architecture/prompt-retention-checklist.md`
...
```text
Please continue from `.dev/refactor-workflows/2026-03-portable-ai-asset-architecture/session-handoff-2026-03-29-stage-g.md`.
Before doing anything else, read:
1. `.dev/refactor-workflows/2026-03-portable-ai-asset-architecture/refactor-plan.md`
2. `.dev/refactor-workflows/2026-03-portable-ai-asset-architecture/stage-g-command-to-skill-convergence.md`
3. `.dev/refactor-workflows/2026-03-portable-ai-asset-architecture/tasks/stage-g-command-to-skill-convergence.json`
4. `.dev/refactor-workflows/2026-03-portable-ai-asset-architecture/prompt-retention-checklist.md`
