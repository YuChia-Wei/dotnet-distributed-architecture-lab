...
description: Draft a selected CBF or SWF file set from requirements, specifications or explicitly scoped code/test observations, preserving source bindings and uncertainty without claiming compliance.
---
