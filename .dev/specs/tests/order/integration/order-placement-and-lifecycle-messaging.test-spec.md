...
- Status: `planned`
- No current test implements the reservation and lifecycle messaging scenarios in this specification.
...
- When:
  - the matching lifecycle use case is invoked with its application input type
- Then:
