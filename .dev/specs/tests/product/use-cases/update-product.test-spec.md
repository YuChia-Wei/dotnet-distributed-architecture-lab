...
- Status: `planned`
- Current tests cover `Product.Update`, but do not directly exercise `IUpdateProductUseCase`.
...
- When:
  - `IUpdateProductUseCase.ExecuteAsync` is invoked with `UpdateProductInput`
- Then:
