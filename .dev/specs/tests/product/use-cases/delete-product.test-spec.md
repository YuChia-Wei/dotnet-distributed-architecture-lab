...
- Status: `partial`
- Current tests cover aggregate deletion and the successful use-case path; the not-found path remains planned.
...
- When:
  - `IDeleteProductUseCase.ExecuteAsync` is invoked with `DeleteProductInput`
- Then:
