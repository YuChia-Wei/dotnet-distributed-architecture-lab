...
- Project inventory: `.dev/project-config.yaml`, originally generated by the retired `repo-structure-sync` entry and refreshed through `ai-context-init` going forward.
