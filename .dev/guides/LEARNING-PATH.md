...
2. `.ai/prompts/shared/architecture-config.md` - architecture rules
3. `.ai/prompts/shared/common-rules.md` - non-negotiable rules
4. `.ai/prompts/shared/testing-strategy.md` - test rules
5. `.ai/prompts/spec-compliance-rules.md` - spec compliance rules

### Phase 2: Learn by examples
1. `.ai/prompts/examples/wolverine-efcore-outbox-example.md` - outbox flow
2. `.ai/prompts/examples/xunit-bddfy-example.md` - BDD test style
3. `.ai/prompts/examples/nsubstitute-example.md` - mocking pattern
4. `.ai/prompts/examples/dto-structure-example.md` - DTO layout
...
1. Find the closest example in `.ai/prompts/examples/`
