...
| Refactor workflow artifact model | Plan/task/report structure exists and now explicitly supports document workflow | `Sufficient` | `.dev/workflows/README.MD`, `AI-REFACTORING-SKILL-CONTRACTS.md`, `AI-COLLABORATION-WORKFLOW-GUIDE.md` | Multi-stage doc work can be tracked without inventing ad hoc structure |
