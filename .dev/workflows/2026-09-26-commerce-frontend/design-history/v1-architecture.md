...
- `src/Frontend/Customer`: standalone Vue3 + TypeScript + Vite application, Vue Router, npm lock, its own Dockerfile and Nginx config. Public base `/web/`.
