...
- BDDfy for BDD scenarios (Gherkin-style naming only)
...
└── CreateTaskUseCaseTests.cs    # BDDfy tests (Gherkin-style naming)
```
...
Scenarios live in test methods and use BDDfy fluent API with Gherkin-style naming.
Use Rule-based prefixes in method names to preserve ezSpec Rule semantics.
