...
description: Execute one local technical target and operation, including direct call sites and immediate tests in the allowed radius. File count alone does not expand scope; new types and semantic boundaries require another owner.
---
